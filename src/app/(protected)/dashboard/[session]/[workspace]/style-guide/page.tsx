...
// const Page = async ({ searchParams }: Props) => {
//   // ❌ await ki zaroorat nahi
//   const { project: projectId } = await searchParams

//   // Try fetching real style guide
//   const existingStyleGuide = await StyleGuideQuery(projectId)
//   const fetchedGuide =
//     existingStyleGuide.styleGuide?._valueJSON as unknown as StyleGuide | undefined

//   // ✅ Real ho to real, warna mock
//   const guide = fetchedGuide || mockStyleGuide

//   const colorGuide = guide.colorSections || []
//   const typographyGuide = guide.typographySections || []

//   // Fetch mood board images (agar baad me chahiye)
//   const existingMoodBoardImages = await MoodBoardImagesQuery(projectId)
//   const guideImages =
