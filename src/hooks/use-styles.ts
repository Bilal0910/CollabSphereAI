...
export const useMoodBoard = (guideImages: MoodBoardImage[]) => {
  ...
  const addModdBoardImage = useMutation(api.moodboard.addMoodBoardImage);
  ...
  const addImage = (file: File) => {
    ...
    toast.success("Image added to mood board successfully.");
  };
  ...
  const removeImage = async (imageId: string) => {
    ...
    setValue("images", updatedImages);
    toast.success("Image removed from mood board successfully.");
  };
