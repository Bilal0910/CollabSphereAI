  ...
  if (data && typeof data === "object") {
    ...
    if (typeof id === "string" && typeof status === "string") {
      return {
        ...
        trial_ends_at: sub.trial_ends_at as string | null | undefined,
        cancel_at: sub.cancel_at as string | null | undefined,
        canceled_at: sub.canceled_at as string | null | undefined,
        customer: sub.customer as PolarCustomer | null | undefined,
        customer_id: sub.customer_id as string | undefined | null,
        product: sub.product as PolarProduct | null | undefined,
        product_id: sub.product_id as string | undefined | null,
        prices: sub.prices as PolarPrice[] | null | undefined,
        seats: (typeof sub.seats === "number" ? sub.seats : undefined) ?? null,
        plan_code: sub.plan_code as string | null | undefined,
        metadata: (sub.metadata as Record<string, string> | undefined) ?? null,
      };
    }
  }
  return null;
...
export const extractOrderLike = (data: unknown): PolarOrder | null => {
  ...
  return {
    id,
    billing_reason: d.billing_reason as string | null | undefined,
    subscription_id: d.subscription_id as string | null | undefined,
    customer: d.customer as PolarCustomer | null | undefined,
    customer_id: d.customer_id as string | null | undefined,
    metadata: (d.metadata as Record<string, string> | undefined) ?? null,
  };
};
