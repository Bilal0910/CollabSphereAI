            ...
            {typographyGuide.length === 0 ? (
                <div className='text-center py-20'>
                    ...
                    <p className='text-sm text-muted-foreground mb-6'>
                        Generate an AI-powered typography recommendation
                    </p>
                </div>
            ) : (
                        ...
                        <div key={index} className='flex flex-col gap-5'>
                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                {section.styles?.map((style: any, styleIndex: number) => (
                                    <div
                                        key={styleIndex}
                                        className='p-6 rounded-2xl backdrop-blur-xl bg-white/[0.02] border
                                         border-white/[0.12] saturate-150'>
                                        ...
                                        <div className='text-xs text-muted-foreground space-y-1'>
                                            ...
                                            <div>Line Height: {style.line}</div>
                                            {style.letterSpacing && (
