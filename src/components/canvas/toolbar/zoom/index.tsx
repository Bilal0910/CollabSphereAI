...
const ZoomBar = () => {
    ...
    return (
        <div className='col-span-1 flex justify-end items-center'>
            <div className='flex items-center gap-1 backdrop-blur-xl bg-white/[0.08] border
         border-white/[0.12] rounded-full p-3 saturate-150'>
                <Button
                    variant='ghost'
                    size='sm'
                    onClick={handleZoomOut}
                    title='Zoom Out'
                    className='w-9 h-9 p-0 rounded-full cursor-pointer hover:bg-white/[0.08] border border-transparent
